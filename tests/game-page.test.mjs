...
test("games page exposes accessible snake, tetris, and tab controls", async () => {
  ...
  assert.match(page, /role=["']tablist["']/i);
  assert.match(page, /id=["']snake-tab["'][^>]+role=["']tab["']/i);
  assert.match(page, /id=["']tetris-tab["'][^>]+role=["']tab["']/i);
  assert.match(page, /id=["']snake-panel["'][^>]+role=["']tabpanel["']/i);
  assert.match(page, /id=["']tetris-panel["'][^>]+role=["']tabpanel["']/i);
  ...
  assert.match(page, /<script\s+type=["']module["']\s+src=["']\.\/tabs\.js["']/i);
});
